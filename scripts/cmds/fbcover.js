...
Example ⇒ {pn} v2 - SHEIKH - ROBOT - NETROKONA - 01_______69 - mdaminsheikh404@gmail.com - green
...
Example ⇒ .fbcover v2 - SHEIKH - ROBOT - NETROKONA - 01_______69 - mdaminsheikh404@gmail.com - green
...
`;
      ...
      const imgEndpoint = `${rubishapi}/fbcover${version}?name=${name}&subname=${subname}&number=${number}&address=${address}&email=${email}&colour=${color}&uid=${uid}&apikey=rubish69`;
